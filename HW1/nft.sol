...
pragma solidity 0.7.0; // for some reason I need to change the solidity version on VS
...
contract MerkleTreeProof is MerkleProof {
    //meta data
    ...
    function updateTree(string memory stuff) external {
        hashes.push(keccak256(abi.encodePacked(stuff)));
        numberOfLeaves = numberOfLeaves + 1;
    }

    function recalculateTree() external{
