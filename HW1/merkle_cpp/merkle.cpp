...
void Merkle_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Merkle_3_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 8860;}
...
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[0]); // line circom 272
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[1],&lvar[221],&circuitConstants[1]); // line circom 273
Fr_eq(&expaux[2],&lvar[221],&circuitConstants[437]); // line circom 273
Fr_lor(&expaux[0],&expaux[1],&expaux[2]); // line circom 273
...
PFrElement aux_dest = &lvar[220];
// load src
Fr_sub(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 276
// end load src
Fr_copy(aux_dest,&lvar[((1 * Fr_toInt(&expaux[0])) + 1)]);
}
}
Fr_eq(&expaux[0],&lvar[221],&circuitConstants[1]); // line circom 278
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[219];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 2]); // line circom 278
// end load src
...
PFrElement aux_dest = &lvar[219];
// load src
Fr_sub(&expaux[3],&lvar[221],&circuitConstants[3]); // line circom 278
Fr_add(&expaux[1],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[3])) + 445)]); // line circom 278
Fr_add(&expaux[0],&expaux[1],&lvar[220]); // line circom 278
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
// load src
Fr_mul(&expaux[0],&lvar[219],&lvar[219]); // line circom 279
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 5)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 5)]); // line circom 280
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[437]); // line circom 281
if(Fr_isTrue(&expaux[0])){
...
PFrElement aux_dest = &lvar[222];
// load src
Fr_sub(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 282
// end load src
...
// load src
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 225)],&lvar[219]); // line circom 283
Fr_add(&expaux[0],&lvar[222],&expaux[2]); // line circom 283
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_eq(&expaux[0],&lvar[221],&circuitConstants[1]); // line circom 284
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 664)];
// load src
Fr_sub(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 284
// end load src
...
// load src
Fr_mul(&expaux[2],&signalValues[mySignalStart + 444],&lvar[219]); // line circom 286
Fr_add(&expaux[0],&signalValues[mySignalStart + 882],&expaux[2]); // line circom 286
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &lvar[221];
// load src
Fr_add(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 272
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[0]); // line circom 272
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 13
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&lvar[3],&circuitConstants[1]); // line circom 16
if(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&signalValues[mySignalStart + 2]); // line circom 20
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mtree[0]";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+891;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mtree[1]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mtree[2]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mtree[3]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mtree[4]";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+5319;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mtree[5]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+7089;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mtree[6]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
Fr_lt(&expaux[0],&lvar[9],&circuitConstants[9]); // line circom 300
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[9])) + 0);
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[9])) + 1)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
...
{
PFrElement aux_dest = &lvar[((1 * Fr_toInt(&lvar[9])) + 2)];
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[9])) + 0)]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[9])) + 0)]].templateId].defs[0].offset+0]);
}
{
PFrElement aux_dest = &lvar[9];
// load src
Fr_add(&expaux[0],&lvar[9],&circuitConstants[3]); // line circom 300
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[9],&circuitConstants[9]); // line circom 300
...
Fr_lt(&expaux[0],&lvar[9],&circuitConstants[15]); // line circom 308
while(Fr_isTrue(&expaux[0])){
Fr_div(&expaux[2],&lvar[9],&circuitConstants[5]); // line circom 310
Fr_add(&expaux[1],&expaux[2],&circuitConstants[9]); // line circom 310
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 310
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[1].offset+map_index_aux[0]];
// load src
Fr_sub(&expaux[0],&lvar[9],&circuitConstants[5]); // line circom 310
// end load src
...
Fr_div(&expaux[2],&lvar[9],&circuitConstants[5]); // line circom 311
Fr_add(&expaux[1],&expaux[2],&circuitConstants[9]); // line circom 311
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 311
{
uint cmp_index_ref = ((1 * Fr_toInt(&expaux[0])) + 0);
{
uint map_index_aux[1];
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[1].offset+map_index_aux[0]];
// load src
Fr_sub(&expaux[0],&lvar[9],&circuitConstants[3]); // line circom 311
// end load src
Fr_copy(aux_dest,&lvar[((1 * Fr_toInt(&expaux[0])) + 2)]);
}
// run sub component if needed
...
Fr_div(&expaux[2],&lvar[9],&circuitConstants[5]); // line circom 312
Fr_add(&expaux[1],&expaux[2],&circuitConstants[9]); // line circom 312
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 312
{
uint cmp_index_ref = ((1 * Fr_toInt(&expaux[0])) + 0);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[2].offset];
...
Fr_div(&expaux[2],&lvar[9],&circuitConstants[5]); // line circom 313
Fr_add(&expaux[1],&expaux[2],&circuitConstants[9]); // line circom 313
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 313
{
...
PFrElement aux_dest = &lvar[9];
// load src
Fr_add(&expaux[0],&lvar[9],&circuitConstants[5]); // line circom 308
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[9],&circuitConstants[15]); // line circom 308
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[6]].templateId].defs[0].offset+0]);
}
}

void run(Circom_CalcWit* ctx){
Merkle_3_create(1,0,ctx,"main",0);
Merkle_3_run(0,ctx);
}
